<?php
    ...
    $tbName = "barf_cat";
    $revision = new DB_con();
    $tbName_revision = "stockout_history_cat";
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = $updatedata->stockOut($total, $number, $id, $tbName);
...
<head>
    ...
    <title>Stock Out - บาร์ฟแมว</title>
...
<body>
    ...
    <a href="barf_cat.php" class="btn btn-color mt-4 fs-6">Back</a>
        <hr>
        <h1 class="mt-5">Stock Out - บาร์ฟแมว</h1>
        <hr>
        <?php
            $id = $_GET['id'];
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                <label for="total" class="form-label">จำนวนที่ต้องการลบ</label>
